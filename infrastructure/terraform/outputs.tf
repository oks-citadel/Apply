...
output "subnet_ids" {
  ...
  value = {
    ...
    app_gateway       = var.enable_application_gateway ? module.networking.app_gateway_subnet_id : null
  }
}
...
output "service_bus_topics" {
  description = "List of Service Bus topic names"
...
output "web_app_name" {
  ...
  value       = module.app_services.web_app_name
}
...
output "web_app_id" {
  ...
  value       = module.app_services.web_app_id
}

output "auth_service_name" {
  description = "Name of the authentication service"
  value       = module.app_services.auth_service_name
}
...
output "auth_service_id" {
  description = "ID of the authentication service"
  value       = module.app_services.auth_service_id
}

output "ai_service_name" {
  description = "Name of the AI service"
  value       = module.app_services.ai_service_name
}
...
output "ai_service_id" {
  description = "ID of the AI service"
  value       = module.app_services.ai_service_id
}

output "app_service_ids" {
  description = "List of all App Service IDs"
...
output "aks_cluster_fqdn" {
  ...
  value       = var.enable_aks ? module.aks[0].aks_cluster_fqdn : null
}
...
output "key_vault_private_endpoint_ip" {
  ...
  value       = var.enable_private_endpoints ? module.private_endpoints[0].key_vault_private_endpoint_ip : null
}

output "sql_private_endpoint_ip" {
  description = "Private IP address of the SQL Server private endpoint"
  value       = var.enable_private_endpoints ? module.private_endpoints[0].sql_private_endpoint_ip : null
}

output "redis_private_endpoint_ip" {
  description = "Private IP address of the Redis Cache private endpoint"
  value       = var.enable_private_endpoints ? module.private_endpoints[0].redis_private_endpoint_ip : null
}
...
output "application_gateway_fqdn" {
  ...
  value       = var.enable_application_gateway ? module.application_gateway[0].app_gateway_fqdn : null
}
