  ...
  private initializeAgentConfigs(): Map<AgentType, AgentConfig> {
    ...
    const baseConfigs: Array<{
    ...
    }> = [
      {
        ...
        defaultUrl: 'http://job-service:3003',
      },
      {
        type: AgentType.JOB_MATCHING,
        name: 'Job Matching Agent',
        urlEnvVar: 'AI_SERVICE_URL',
        defaultUrl: 'http://ai-service:3004',
      },
      {
      ...
      },
      {
        ...
        defaultUrl: 'http://auto-apply-service:3008',
      },
      {
      ...
      },
      {
        ...
        defaultUrl: 'http://resume-service:3005',
      },
      {
